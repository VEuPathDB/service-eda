...
public class LineplotPostRequestImpl implements LineplotPostRequest {
  ...
  @JsonProperty("config")
  public LineplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(LineplotSpec config) {
    this.config = config;
  }
}
