...
@JsonDeserialize(
    as = StandaloneMapMarkersPostRequestImpl.class
)
public interface StandaloneMapMarkersPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  StandaloneMapMarkersSpec getConfig();

  @JsonProperty("config")
  void setConfig(StandaloneMapMarkersSpec config);
}
