...
public class FloatingContTablePostRequestImpl implements FloatingContTablePostRequest {
  ...
  @JsonProperty("config")
  private FloatingContTableSpec config;
  ...
  @JsonProperty("config")
  public FloatingContTableSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(FloatingContTableSpec config) {
    this.config = config;
  }
}
