...
@JsonDeserialize(
    as = BarplotPostRequestImpl.class
)
public interface BarplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  BarplotSpec getConfig();

  @JsonProperty("config")
  void setConfig(BarplotSpec config);
}
