...
public class DensityplotPostRequestImpl implements DensityplotPostRequest {
  ...
  @JsonProperty("config")
  private DensityplotSpec config;
  ...
  @JsonProperty("config")
  public DensityplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(DensityplotSpec config) {
    this.config = config;
  }
}
