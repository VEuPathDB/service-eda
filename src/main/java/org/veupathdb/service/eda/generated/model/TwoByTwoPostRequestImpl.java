...
public class TwoByTwoPostRequestImpl implements TwoByTwoPostRequest {
  ...
  @JsonProperty("config")
  public TwoByTwoSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(TwoByTwoSpec config) {
    this.config = config;
  }
}
