...
public class StandaloneMapMarkersPostRequestImpl implements StandaloneMapMarkersPostRequest {
  ...
  @JsonProperty("config")
  private StandaloneMapMarkersSpec config;
  ...
  @JsonProperty("config")
  public StandaloneMapMarkersSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(StandaloneMapMarkersSpec config) {
    this.config = config;
  }
}
