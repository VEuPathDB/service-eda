...
public class ScatterplotPostRequestImpl implements ScatterplotPostRequest {
  ...
  @JsonProperty("config")
  private ScatterplotSpec config;
  ...
  @JsonProperty("config")
  public ScatterplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(ScatterplotSpec config) {
    this.config = config;
  }
}
