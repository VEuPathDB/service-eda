...
public class RecordCountPostRequestImpl implements RecordCountPostRequest {
  ...
  @JsonProperty("config")
  private RecordCountSpec config;
  ...
  @JsonProperty("config")
  public RecordCountSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(RecordCountSpec config) {
    this.config = config;
  }
}
