...
open class RequestResourcesBase
@Throws(ValidationException::class)
constructor (request: DerivedVariableBulkMetadataRequest)
{
  private val logger = logger()

  val metadata = ReferenceMetadata(EdaSubsettingClient.getStudy(request.studyId))

  val derivedVariableSpecs = request.derivedVariables ?: emptyList()
