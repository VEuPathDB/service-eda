...
public class FloatingLineplotPostRequestImpl implements FloatingLineplotPostRequest {
  ...
  @JsonProperty("config")
  private FloatingLineplotSpec config;
  ...
  @JsonProperty("config")
  public FloatingLineplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(FloatingLineplotSpec config) {
    this.config = config;
  }
}
