...
@JsonDeserialize(
    as = CorrelationAssayAssayBipartitenetworkPostRequestImpl.class
)
public interface CorrelationAssayAssayBipartitenetworkPostRequest extends DataPluginRequestBase {
  ...
  CorrelationAssayAssayConfig getComputeConfig();

  @JsonProperty("computeConfig")
  void setComputeConfig(CorrelationAssayAssayConfig computeConfig);
