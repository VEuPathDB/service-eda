...
@JsonDeserialize(
    as = AbundanceScatterplotPostRequestImpl.class
)
public interface AbundanceScatterplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  ScatterplotWith1ComputeSpec getConfig();

  @JsonProperty("config")
  void setConfig(ScatterplotWith1ComputeSpec config);
}
