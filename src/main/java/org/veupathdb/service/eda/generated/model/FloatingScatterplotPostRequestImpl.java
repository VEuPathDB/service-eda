...
public class FloatingScatterplotPostRequestImpl implements FloatingScatterplotPostRequest {
  ...
  @JsonProperty("config")
  private FloatingScatterplotSpec config;
  ...
  @JsonProperty("config")
  public FloatingScatterplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(FloatingScatterplotSpec config) {
    this.config = config;
  }
}
