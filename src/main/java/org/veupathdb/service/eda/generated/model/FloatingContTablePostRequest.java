...
@JsonDeserialize(
    as = FloatingContTablePostRequestImpl.class
)
public interface FloatingContTablePostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  FloatingContTableSpec getConfig();

  @JsonProperty("config")
  void setConfig(FloatingContTableSpec config);
}
