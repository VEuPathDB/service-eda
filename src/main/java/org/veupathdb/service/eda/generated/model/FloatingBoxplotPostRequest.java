...
@JsonDeserialize(
    as = FloatingBoxplotPostRequestImpl.class
)
public interface FloatingBoxplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  FloatingBoxplotSpec getConfig();

  @JsonProperty("config")
  void setConfig(FloatingBoxplotSpec config);
}
