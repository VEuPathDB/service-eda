...
public class TestCollectionsPostRequestImpl implements TestCollectionsPostRequest {
  ...
  @JsonProperty("config")
  public CollectionSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(CollectionSpec config) {
    this.config = config;
  }
}
