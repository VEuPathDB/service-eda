...
public class StandaloneMapBubblesSpecImpl implements StandaloneMapBubblesSpec {
  ...
  private QuantitativeOverlayConfig overlayConfig;
  ...
  @JsonProperty("overlayConfig")
  public QuantitativeOverlayConfig getOverlayConfig() {
    return this.overlayConfig;
  }

  @JsonProperty("overlayConfig")
  public void setOverlayConfig(QuantitativeOverlayConfig overlayConfig) {
