...
@JsonDeserialize(
    as = MapMarkersOverlayPostRequestImpl.class
)
public interface MapMarkersOverlayPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  MapMarkersOverlaySpec getConfig();

  @JsonProperty("config")
  void setConfig(MapMarkersOverlaySpec config);
}
