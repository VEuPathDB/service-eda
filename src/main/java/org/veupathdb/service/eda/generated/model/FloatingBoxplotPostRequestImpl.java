...
public class FloatingBoxplotPostRequestImpl implements FloatingBoxplotPostRequest {
  ...
  @JsonProperty("config")
  private FloatingBoxplotSpec config;
  ...
  @JsonProperty("config")
  public FloatingBoxplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(FloatingBoxplotSpec config) {
    this.config = config;
  }
}
