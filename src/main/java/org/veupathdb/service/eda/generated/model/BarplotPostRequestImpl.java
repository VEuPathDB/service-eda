...
public class BarplotPostRequestImpl implements BarplotPostRequest {
  ...
  @JsonProperty("config")
  public BarplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(BarplotSpec config) {
    this.config = config;
  }
}
