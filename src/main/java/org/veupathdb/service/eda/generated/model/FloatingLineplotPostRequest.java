...
@JsonDeserialize(
    as = FloatingLineplotPostRequestImpl.class
)
public interface FloatingLineplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  FloatingLineplotSpec getConfig();

  @JsonProperty("config")
  void setConfig(FloatingLineplotSpec config);
}
