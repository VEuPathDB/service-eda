...
public class MapMarkersOverlayPostRequestImpl implements MapMarkersOverlayPostRequest {
  ...
  @JsonProperty("config")
  private MapMarkersOverlaySpec config;
  ...
  @JsonProperty("config")
  public MapMarkersOverlaySpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(MapMarkersOverlaySpec config) {
    this.config = config;
  }
}
