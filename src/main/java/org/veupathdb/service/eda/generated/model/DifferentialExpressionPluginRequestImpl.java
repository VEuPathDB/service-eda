...
public class DifferentialExpressionPluginRequestImpl implements DifferentialExpressionPluginRequest {
  ...
  @JsonProperty("config")
  private DifferentialExpressionComputeConfig config;
  ...
  @JsonProperty("config")
  public DifferentialExpressionComputeConfig getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(DifferentialExpressionComputeConfig config) {
    this.config = config;
  }
