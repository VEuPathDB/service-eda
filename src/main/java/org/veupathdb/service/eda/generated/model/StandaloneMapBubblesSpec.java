...
@JsonDeserialize(
    as = StandaloneMapBubblesSpecImpl.class
)
public interface StandaloneMapBubblesSpec {
  ...
  QuantitativeOverlayConfig getOverlayConfig();

  @JsonProperty("overlayConfig")
  void setOverlayConfig(QuantitativeOverlayConfig overlayConfig);
