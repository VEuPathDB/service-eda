...
public class ContinuousVariableMetadataPostRequestImpl implements ContinuousVariableMetadataPostRequest {
  ...
  @JsonProperty("config")
  private ContinuousVariableMetadataSpec config;
  ...
  @JsonProperty("config")
  public ContinuousVariableMetadataSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(ContinuousVariableMetadataSpec config) {
    this.config = config;
  }
}
