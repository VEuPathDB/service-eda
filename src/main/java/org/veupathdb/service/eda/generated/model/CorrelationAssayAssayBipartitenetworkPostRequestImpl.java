...
public class CorrelationAssayAssayBipartitenetworkPostRequestImpl implements CorrelationAssayAssayBipartitenetworkPostRequest {
  ...
  private CorrelationAssayAssayConfig computeConfig;
  ...
  @JsonProperty("computeConfig")
  public CorrelationAssayAssayConfig getComputeConfig() {
    return this.computeConfig;
  }

  @JsonProperty("computeConfig")
  public void setComputeConfig(CorrelationAssayAssayConfig computeConfig) {
