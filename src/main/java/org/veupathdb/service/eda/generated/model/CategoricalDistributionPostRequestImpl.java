...
public class CategoricalDistributionPostRequestImpl implements CategoricalDistributionPostRequest {
  ...
  @JsonProperty("config")
  public VariableSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(VariableSpec config) {
    this.config = config;
  }
}
