...
@JsonDeserialize(
    as = ScatterplotPostRequestImpl.class
)
public interface ScatterplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  ScatterplotSpec getConfig();

  @JsonProperty("config")
  void setConfig(ScatterplotSpec config);
}
