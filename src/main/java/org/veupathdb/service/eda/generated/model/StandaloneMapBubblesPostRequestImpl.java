...
public class StandaloneMapBubblesPostRequestImpl implements StandaloneMapBubblesPostRequest {
  ...
  @JsonProperty("config")
  private StandaloneMapBubblesSpec config;
  ...
  @JsonProperty("config")
  public StandaloneMapBubblesSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(StandaloneMapBubblesSpec config) {
    this.config = config;
  }
}
