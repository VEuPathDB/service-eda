...
public class CollectionFloatingLineplotPostRequestImpl implements CollectionFloatingLineplotPostRequest {
  ...
  @JsonProperty("config")
  private CollectionFloatingLineplotSpec config;
  ...
  @JsonProperty("config")
  public CollectionFloatingLineplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(CollectionFloatingLineplotSpec config) {
    this.config = config;
  }
}
