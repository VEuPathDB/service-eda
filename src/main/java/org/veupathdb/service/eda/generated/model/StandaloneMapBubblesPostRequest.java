...
@JsonDeserialize(
    as = StandaloneMapBubblesPostRequestImpl.class
)
public interface StandaloneMapBubblesPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  StandaloneMapBubblesSpec getConfig();

  @JsonProperty("config")
  void setConfig(StandaloneMapBubblesSpec config);
}
