...
public class MosaicPostRequestImpl implements MosaicPostRequest {
  ...
  @JsonProperty("config")
  public MosaicSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(MosaicSpec config) {
    this.config = config;
  }
}
