...
@JsonDeserialize(
    as = FloatingBarplotPostRequestImpl.class
)
public interface FloatingBarplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  FloatingBarplotSpec getConfig();

  @JsonProperty("config")
  void setConfig(FloatingBarplotSpec config);
}
