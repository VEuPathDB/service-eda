...
public class CollectionMapMarkerElementImpl implements CollectionMapMarkerElement {
  ...
  private List<CollectionMemberAggregate> overlayValues;
  ...
  @JsonProperty("overlayValues")
  public List<CollectionMemberAggregate> getOverlayValues() {
    return this.overlayValues;
  }

  @JsonProperty("overlayValues")
  public void setOverlayValues(List<CollectionMemberAggregate> overlayValues) {
