...
@JsonDeserialize(
    as = FloatingScatterplotPostRequestImpl.class
)
public interface FloatingScatterplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  FloatingScatterplotSpec getConfig();

  @JsonProperty("config")
  void setConfig(FloatingScatterplotSpec config);
}
