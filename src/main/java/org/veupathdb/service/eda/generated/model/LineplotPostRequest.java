...
@JsonDeserialize(
    as = LineplotPostRequestImpl.class
)
public interface LineplotPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  LineplotSpec getConfig();

  @JsonProperty("config")
  void setConfig(LineplotSpec config);
}
