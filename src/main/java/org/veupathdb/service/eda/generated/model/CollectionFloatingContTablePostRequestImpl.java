...
public class CollectionFloatingContTablePostRequestImpl implements CollectionFloatingContTablePostRequest {
  ...
  @JsonProperty("config")
  private CollectionFloatingContTableSpec config;
  ...
  @JsonProperty("config")
  public CollectionFloatingContTableSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(CollectionFloatingContTableSpec config) {
    this.config = config;
  }
}
