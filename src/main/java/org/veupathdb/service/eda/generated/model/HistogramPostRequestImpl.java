...
public class HistogramPostRequestImpl implements HistogramPostRequest {
  ...
  @JsonProperty("config")
  public HistogramSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(HistogramSpec config) {
    this.config = config;
  }
}
