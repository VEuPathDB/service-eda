...
public class StandaloneMapElementInfoImpl implements StandaloneMapElementInfo {
  ...
  private List<LegacyLabeledRangeWithCountAndValue> overlayValues;
  ...
  @JsonProperty("overlayValues")
  public List<LegacyLabeledRangeWithCountAndValue> getOverlayValues() {
    return this.overlayValues;
  }

  @JsonProperty("overlayValues")
  public void setOverlayValues(List<LegacyLabeledRangeWithCountAndValue> overlayValues) {
