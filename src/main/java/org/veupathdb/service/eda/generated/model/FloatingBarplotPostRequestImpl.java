...
public class FloatingBarplotPostRequestImpl implements FloatingBarplotPostRequest {
  ...
  @JsonProperty("config")
  private FloatingBarplotSpec config;
  ...
  @JsonProperty("config")
  public FloatingBarplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(FloatingBarplotSpec config) {
    this.config = config;
  }
}
