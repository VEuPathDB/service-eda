...
public class CollectionFloatingBoxplotPostRequestImpl implements CollectionFloatingBoxplotPostRequest {
  ...
  @JsonProperty("config")
  private CollectionFloatingBoxplotSpec config;
  ...
  @JsonProperty("config")
  public CollectionFloatingBoxplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(CollectionFloatingBoxplotSpec config) {
    this.config = config;
  }
}
