...
@JsonDeserialize(
    as = TestCollectionsPostRequestImpl.class
)
public interface TestCollectionsPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  CollectionSpec getConfig();

  @JsonProperty("config")
  void setConfig(CollectionSpec config);
}
