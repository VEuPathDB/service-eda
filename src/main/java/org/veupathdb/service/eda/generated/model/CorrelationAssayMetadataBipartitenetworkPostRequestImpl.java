...
public class CorrelationAssayMetadataBipartitenetworkPostRequestImpl implements CorrelationAssayMetadataBipartitenetworkPostRequest {
  ...
  private CorrelationAssayMetadataConfig computeConfig;
  ...
  @JsonProperty("computeConfig")
  public CorrelationAssayMetadataConfig getComputeConfig() {
    return this.computeConfig;
  }

  @JsonProperty("computeConfig")
  public void setComputeConfig(CorrelationAssayMetadataConfig computeConfig) {
