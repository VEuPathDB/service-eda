...
public class FloatingHistogramPostRequestImpl implements FloatingHistogramPostRequest {
  ...
  @JsonProperty("config")
  private FloatingHistogramSpec config;
  ...
  @JsonProperty("config")
  public FloatingHistogramSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(FloatingHistogramSpec config) {
    this.config = config;
  }
}
