...
public class BoxplotPostRequestImpl implements BoxplotPostRequest {
  ...
  @JsonProperty("config")
  public BoxplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(BoxplotSpec config) {
    this.config = config;
  }
}
