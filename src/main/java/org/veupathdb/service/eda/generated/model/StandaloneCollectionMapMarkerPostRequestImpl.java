...
public class StandaloneCollectionMapMarkerPostRequestImpl implements StandaloneCollectionMapMarkerPostRequest {
  ...
  @JsonProperty("config")
  private StandaloneCollectionMapMarkerSpec config;
  ...
  @JsonProperty("config")
  public StandaloneCollectionMapMarkerSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(StandaloneCollectionMapMarkerSpec config) {
    this.config = config;
  }
}
