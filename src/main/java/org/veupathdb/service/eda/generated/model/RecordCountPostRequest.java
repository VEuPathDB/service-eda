...
@JsonDeserialize(
    as = RecordCountPostRequestImpl.class
)
public interface RecordCountPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  RecordCountSpec getConfig();

  @JsonProperty("config")
  void setConfig(RecordCountSpec config);
}
