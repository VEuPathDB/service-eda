...
@JsonDeserialize(
    as = HistogramPostRequestImpl.class
)
public interface HistogramPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  HistogramSpec getConfig();

  @JsonProperty("config")
  void setConfig(HistogramSpec config);
}
