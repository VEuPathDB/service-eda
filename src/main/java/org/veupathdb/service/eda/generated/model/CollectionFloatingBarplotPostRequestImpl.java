...
public class CollectionFloatingBarplotPostRequestImpl implements CollectionFloatingBarplotPostRequest {
  ...
  @JsonProperty("config")
  private CollectionFloatingBarplotSpec config;
  ...
  @JsonProperty("config")
  public CollectionFloatingBarplotSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(CollectionFloatingBarplotSpec config) {
    this.config = config;
  }
}
