...
@JsonDeserialize(
    as = CollectionMapMarkerElementImpl.class
)
public interface CollectionMapMarkerElement extends BaseMarker {
  ...
  List<CollectionMemberAggregate> getOverlayValues();

  @JsonProperty("overlayValues")
  void setOverlayValues(List<CollectionMemberAggregate> overlayValues);
}
