...
public class AbundanceScatterplotPostRequestImpl implements AbundanceScatterplotPostRequest {
  ...
  private RankedAbundanceComputeConfig computeConfig;

  @JsonProperty("config")
  private ScatterplotWith1ComputeSpec config;
  ...
  @JsonProperty("computeConfig")
  public RankedAbundanceComputeConfig getComputeConfig() {
    return this.computeConfig;
  }

  @JsonProperty("computeConfig")
  public void setComputeConfig(RankedAbundanceComputeConfig computeConfig) {
    this.computeConfig = computeConfig;
  }

  @JsonProperty("config")
  public ScatterplotWith1ComputeSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(ScatterplotWith1ComputeSpec config) {
    this.config = config;
  }
}
