...
public class CorrelationAssayMetadataConfigImpl implements CorrelationAssayMetadataConfig {
  ...
  @JsonProperty("data2")
  private CorrelationInputDataMetadata data2;
  ...
  @JsonProperty("data2")
  public CorrelationInputDataMetadata getData2() {
    return this.data2;
  }

  @JsonProperty("data2")
  public void setData2(CorrelationInputDataMetadata data2) {
    this.data2 = data2;
  }
