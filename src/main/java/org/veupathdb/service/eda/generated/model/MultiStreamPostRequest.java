...
@JsonDeserialize(
    as = MultiStreamPostRequestImpl.class
)
public interface MultiStreamPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  MultiStreamSpec getConfig();

  @JsonProperty("config")
  void setConfig(MultiStreamSpec config);
}
