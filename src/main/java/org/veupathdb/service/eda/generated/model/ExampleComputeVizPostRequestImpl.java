...
public class ExampleComputeVizPostRequestImpl implements ExampleComputeVizPostRequest {
  ...
  @JsonProperty("config")
  private ExampleComputeVizSpec config;

  @JsonProperty("computeConfig")
  private ExampleComputeConfig computeConfig;
  ...
  @JsonProperty("config")
  public ExampleComputeVizSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(ExampleComputeVizSpec config) {
    this.config = config;
  }

  @JsonProperty("computeConfig")
  public ExampleComputeConfig getComputeConfig() {
    return this.computeConfig;
  }

  @JsonProperty("computeConfig")
  public void setComputeConfig(ExampleComputeConfig computeConfig) {
