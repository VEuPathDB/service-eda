...
public class DifferentialAbundanceVolcanoplotPostRequestImpl implements DifferentialAbundanceVolcanoplotPostRequest {
  ...
  private DifferentialAbundanceComputeConfig computeConfig;
  ...
  @JsonProperty("computeConfig")
  public DifferentialAbundanceComputeConfig getComputeConfig() {
    return this.computeConfig;
  }

  @JsonProperty("computeConfig")
  public void setComputeConfig(DifferentialAbundanceComputeConfig computeConfig) {
