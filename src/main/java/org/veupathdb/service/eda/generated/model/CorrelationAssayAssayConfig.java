...
@JsonDeserialize(
    as = CorrelationAssayAssayConfigImpl.class
)
public interface CorrelationAssayAssayConfig extends BaseCorrelationComputeConfig {
  ...
  @JsonProperty("data2")
  CorrelationInputDataCollection getData2();

  @JsonProperty("data2")
  void setData2(CorrelationInputDataCollection data2);
