...
public class SelfCorrelationUnipartitenetworkPostRequestImpl implements SelfCorrelationUnipartitenetworkPostRequest {
  ...
  private SelfCorrelationConfig computeConfig;
  ...
  @JsonProperty("computeConfig")
  public SelfCorrelationConfig getComputeConfig() {
    return this.computeConfig;
  }

  @JsonProperty("computeConfig")
  public void setComputeConfig(SelfCorrelationConfig computeConfig) {
