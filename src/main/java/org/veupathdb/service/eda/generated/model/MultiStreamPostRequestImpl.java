...
public class MultiStreamPostRequestImpl implements MultiStreamPostRequest {
  ...
  @JsonProperty("config")
  private MultiStreamSpec config;
  ...
  @JsonProperty("config")
  public MultiStreamSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(MultiStreamSpec config) {
    this.config = config;
  }
}
