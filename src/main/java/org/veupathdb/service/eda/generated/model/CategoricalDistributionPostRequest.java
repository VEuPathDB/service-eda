...
@JsonDeserialize(
    as = CategoricalDistributionPostRequestImpl.class
)
public interface CategoricalDistributionPostRequest extends DataPluginRequestBase {
  ...
  @JsonProperty("config")
  VariableSpec getConfig();

  @JsonProperty("config")
  void setConfig(VariableSpec config);
}
