...
public class HeatmapPostRequestImpl implements HeatmapPostRequest {
  ...
  @JsonProperty("config")
  public HeatmapSpec getConfig() {
    return this.config;
  }

  @JsonProperty("config")
  public void setConfig(HeatmapSpec config) {
    this.config = config;
  }
}
